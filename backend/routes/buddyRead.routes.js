...
import { buddyReadCreation, shareBuddyRead, getMyBuddyReads, endBuddyRead, deleteBuddyRead, removeSharing, checkBuddyRead } from "../controllers/buddyRead.controller.js";
...
router.get("/check/:bookInShelfId", checkBuddyRead);
